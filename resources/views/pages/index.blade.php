 ...
 @section('content')
     ...
     <section class="bg-gray-700 bg-cover bg-center bg-no-repeat bg-blend-multiply"
         ...
         <div class="mx-auto max-w-screen-xl px-4 py-24 text-center lg:py-56">
             ...
             <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                 ...
                 <a href="https://karangwuni-sukoharjo.desa.id/"
     ...
     {{-- SERVICE CARD --}}
     <section class="bg-slate-100 p-4 py-8" id="cekPenerimaBantuan">
         <div class="mx-auto my-4 flex justify-center">
             <h2 class="inline-block rounded-full bg-white p-2 px-4 text-2xl font-bold">Cek Penerima Bantuan Tahun Ini</h2>
         </div>
