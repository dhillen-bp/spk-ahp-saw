                    ...
                    @section('content')
                        <section class="bg-slate-100">
                            ...
                            <div class="-mb-16 p-4 md:px-6">
                                <div class="relative -top-24 mx-2 rounded-lg bg-blue-100 p-8 sm:mx-4 md:mx-8">
                                    <div class="rounded-lg bg-blue-700 p-4 text-white">
                                        <h3 class="text-center text-xl font-bold">Pengumuman Terkait Pengambilan BLT Dana
                                            Desa 2024</h3>
                                        <div class="my-4">
                                            <ol class="list-inside list-decimal space-y-2">
                                                <li>BLT Dana Desa dapat diambil ke balai desa pada hari Senin, 10 Juni 2024
                                                    mulai pukul 09.00.
                                                </li>
                                                <li>Jika tidak bisa datang, bisa diwakilkan dengan membawa fotokopi KK/KTP
                                                    penerima.</li>
                                                <li>Jika ada yang ingin ditanyakan lebih lanjut, hubungi ...</li>
                                            </ol>
                                        </div>
                                    ...
                                    @if ($rankingResults->isNotEmpty())
                                        <div class="mt-8 pb-4">
                                            <h3 class="text-center text-xl font-bold">Daftar Calon Penerima BLT DD</h3>

                                            <div class="relative overflow-x-auto bg-slate-100 shadow-md sm:rounded-lg">
                                                <div
                                                    class="flex-column flex flex-wrap items-center justify-between space-y-4 pb-4 sm:flex-row sm:space-y-0">
                                                    <div>
                                                        <button id="dropdownRadioButton"
                                                            ...
                                                            class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
                                                            type="button">
                                                            <svg class="me-3 h-3 w-3 text-gray-500 dark:text-gray-400"
                                                        ...
                                                        <div id="dropdownRadio"
                                                            ...
                                                            <ul class="space-y-1 p-3 text-sm text-gray-700 dark:text-gray-200"
                                                                aria-labelledby="dropdownRadioButton">
                                                                <form method="GET"
                                                                    action="{{ route('pengumuman.penerima') }}"
                                                                    id="yearFilterForm">
                                                                    @foreach ($criteriaSelected as $pilihan)
                                                                        <li>
                                                                            <div
                                                ...
                                                <div class="mb-4 flex space-x-4">
                                                    <div class="flex items-center space-x-2">
                                                        ...
                                                        <span class="text-sm text-gray-900 dark:text-white">Lolos
                                                            Verifikasi</span>
                                                    </div>
                                                    <div class="flex items-center space-x-2">
                                                        <div class="h-4 w-4 rounded-full bg-red-200"></div>
                                                        <span class="text-sm text-gray-900 dark:text-white">Tidak Lolos
                                                            Verifikasi</span>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="w-full text-left text-sm text-gray-500 rtl:text-right">
                                                    <thead
                                                        class="bg-slate-50 text-center text-xs font-bold uppercase text-gray-700">
                                                        <tr>
                                                    ...
                                                    <tbody class="text-center">
                                                        @foreach ($rankingResults as $data)
                                                            <tr
                                                                ...
                                                                <td class="px-6 py-4">
                                                                    <button
                                                                        data-modal-target="keterangan-modal-{{ $loop->iteration }}"
                                                                        data-modal-toggle="keterangan-modal-{{ $loop->iteration }}"
                                                                        class="btn-primary rounded-lg px-2.5 py-1.5 text-xs"
                                                                        type="button">
                                                                        Keterangan
                                                                    </button>
                                                                </td>
