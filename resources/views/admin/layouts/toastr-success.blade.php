...
<div id="toast-success"
    class="absolute right-4 top-16 z-50 mb-4 flex w-full max-w-xs items-center rounded-lg border-2 border-green-500 bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
    role="alert">
    <div
