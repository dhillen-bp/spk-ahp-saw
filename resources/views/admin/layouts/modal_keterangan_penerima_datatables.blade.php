<!-- Large Modal -->
<div id="keterangan-modal" tabindex="-1"
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between rounded-t border-b p-4 dark:border-gray-600 md:p-5">
                ...
                <button type="button"
                    ...
                    data-modal-hide="keterangan-modal">
            ...
            <div class="space-y-4 p-4 md:p-5">
                <div class="space-y-4 text-sm">
                    <div><strong>Nama:</strong> <span class="dataNama"></span> </div>
                    <div class="flex space-x-1"><strong>Verifikasi:</strong>
                        <div class="dataIsVerified">

                        </div>
                    </div>
                    <div class="space-x-1"><strong>Verifikasi Deskripsi: </strong> <span
                            class="dataIsVerifiedDesc"></span>
                    </div>
                </div>
            </div>
            <!-- Modal footer -->
            <div class="flex items-center rounded-b border-t border-gray-200 p-4 dark:border-gray-600 md:p-5">
                {{-- <button data-modal-hide="keterangan-modal" type="button"
