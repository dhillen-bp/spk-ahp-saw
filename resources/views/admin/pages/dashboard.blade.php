    ...
    <div class="grid grid-cols-2 gap-5 md:grid-cols-3">
        <div class="max-w-sm rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                ...
                <div class="flex flex-col items-center">
                    <svg class="h-20 w-20 text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flex text-blue-500">
                        <span>0%</span>
                        <svg class="h-6 w-6 text-blue-500 dark:text-white" aria-hidden="true"
        ...
        <div class="max-w-sm rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                ...
                <div class="flex flex-col items-center">
                    <svg class="h-20 w-20 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                    ...
                    <div class="flex text-green-500">
                        <span>5%</span>
                        <svg class="h-6 w-6 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
