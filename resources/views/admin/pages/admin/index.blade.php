...
@section('content')
    <div class="my-10">
        <h1 class="my-4 text-3xl font-bold">DATA ADMIN</h1>
            ...
            <ol class="inline-flex items-center space-x-1 rtl:space-x-reverse md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Data Admin</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="mt-8 pb-4">
        <div class="mb-2 flex justify-between">
            <h3 class="mb-2 text-xl font-bold">Tabel Data Admin</h3>
        </div>
                ...
                <tbody class="text-center">
                    @foreach ($admin as $data)
                        <tr class="text-gray-900 odd:bg-white even:bg-blue-50 hover:bg-gray-50 even:hover:bg-blue-100">
                            ...
                            <td class="px-6 py-4">
                                <span class="{{ $data->role == 'pemerintah_desa' ? 'badge-benefit' : 'badge-cost' }}">
                                    {{ $data->role }}</span>
                            </td>
                            <td class="px-6 py-4">
                                {{ $data->desc }}
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.data_admin.edit', $data->id) }}"
                        ...
                        @component('admin.layouts.modal_delete', [
                            ...
                            'deletedId' => $data->id,
                            'routeName' => 'admin.data_admin.destroy',
                        ])
                        @endcomponent
                    @endforeach
                </tbody>
        ...
        {{-- PAGINATION --}}
        <div>
            {{ $admin->links('vendor.pagination.tailwind') }}
        </div>
    </div>
@endsection
