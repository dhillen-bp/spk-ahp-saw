...
@section('content')
            ...
            <ol class="inline-flex items-center space-x-1 rtl:space-x-reverse md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.kriteria.sub.compare', $criteriaId) }}"
    ...
    <div class="space-y-10 pb-6">
        ...
        @if ($cr < 0.1)
            ...
            <form method="POST" action="{{ route('admin.kriteria.sub.compareSaveValue', $criteriaId) }}">
                @csrf
                @method('PATCH')
                <input type="hidden" name="subcriteria_value" value="{{ json_encode($priorityValues) }}">
                <button type="submit"
