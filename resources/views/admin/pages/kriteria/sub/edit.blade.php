...
@section('content')
    <div class="my-10">
        <h1 class="my-4 text-3xl font-bold">EDIT SUBKRITERIA</h1>
            ...
            <ol class="inline-flex items-center space-x-1 rtl:space-x-reverse md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.kriteria.show', $subcriteria->criteria_id) }}"
    ...
    <div class="grid grid-cols-1 space-y-5 md:grid-cols-5 md:space-x-10 md:space-y-0">
        ...
        <form method="POST" action="{{ route('admin.kriteria.sub.update', $subcriteria->id) }}"
            ...
            <div class="mb-5">
                ...
                <input type="text" id="nama" name="nama"
                    ...
                    value="{{ old('nama') ?? $subcriteria->nama }}" />
                @error('nama')
